...
// images
import User from '../../assets/img/blog/user.png';
import PostImg from '../../assets/img/blog/post.svg';
import Quote from '../../assets/img/blog/quote.png';
import Dialog from '../../assets/img/blog/dialog.png';
import Sun from '../../assets/img/blog/sun.png';
    ...
    return (
        ...
        <div className="postPage__wrapper page-wrapper">
          ...
          <div className="post__row">
            <div className="post__date">5 апреля 2015</div>
            <div className="post__author">
                <img src={User} alt="User Img" className="post__author-img"/>
                <span className="post__author-name">Роман Кичан</span>
            </div>            
            <div className="post__view">
                <i className="icon-eye"></i>
                <span className="post__view-number">999 999</span>
            </div>
            <div className="post__comment">
                <i className="icon-comment"></i>
                <span className="post__comment-number">999 999</span>
            </div>
        </div>
        <div className="post__content">
    <svg className="post__content-img postPage__img" version="1.0" xmlns="http://www.w3.org/2000/svg"
        width="100%" height="auto" viewBox="0 0 488.000000 322.000000"
        ...
        -5 -3 -8 -7z"/>
            ...
            <span className="post__content-title postPage__title">Возможные риски на фондовом рынке</span>
        <div className="postPage__soc">
          <div className="postPage__soci vk"><i className="icon-vk"></i></div>
          <div className="postPage__soci fb"><i className="icon-fb"></i></div>
          <div className="postPage__soci tw"><i className="icon-twitter"></i></div>
          <div className="postPage__soci plus">+</div>
          ...
          <span className="post__body-title"><img src={Quote} alt="Quote" className="post__quote"/> «Если у Вас есть возможность инвестировать,<br/> найдутся те, кто потенциально хочет присвоить ваши<br/> средства себе!»
</span>
        <p className="post__body-text">
            Будьте внимательны и запоминайте!<br/><br/>
            Разбираем сегодня реальные инструменты поведения и лайфхаки  для защиты от финансовых мошенников.<br/><br/>
            Я четырнадцать лет работаю в инвестиционных компаниях, и знаю все нюансы управления чужими финансами. Гарантирую, что применяя эти инструменты, вы перестанете быть интересны мошенникам.<br/><br/>
            В конце статьи будет алгоритм, напоминающий как вести себя при разного рода звонках. Количество пострадавших от финансовых мошенников очень и очень много. Мы знаем из телевизора о тысячах обманутых вкладчиков, но мало что слышал об инвестициях, которые люди теряют, благодаря коварству мошенников или собственной нерасчетливости.<br/><br/>
            Мошенники на финансовых рынках существуют с самого рождения самих рынков, как только появилось такое слово, как «ДОВЕРИЕ». Ведь финансовые рынки -  это в первую очередь сделки, где стороны доверяют друг другу. Тут сразу и стал появляться «первый снег». Индивиды,  которые понимают, что если завладеть доверием другой стороны, то можно неплохо заработать в денежных знаках.<br/><br/>
            Рассмотрим сегодняшние кейсы.
        </p>
        <span className="post__body-h2">КЕЙС 1.<br/> Классическая схема отъема денежных средств у доверчивых граждан под “соусом” финансовых рынков.
        </span>
        <span className="post__body-h3">Как это происходит?</span>
        <p className="post__body-text">
            Нам на телефон звонит менеджер незнакомой нам финансовой компании и предлагает заработать много денег с помощью него и его компании. Очень хорошо говорит, уверенно и вроде имеет определенную экспертизу. Ну а как иначе? Он звонит по 70 звонков в день! Много дней.<br/><br/>

            Как работают? Просто.<br/><br/>

            Используют психологические практики влияния на людей.<br/><br/>

            Вот собственно описание их Целевой аудитории:<br/><br/>
        </p>
        <ul>
          <li className="post__li">Человек, зарабатывающий около 100К рублей в месяц;</li>
          <li className="post__li">Данный человек  считает себя изрядно умным, часто обосновано;</li>
          <li className="post__li">Он уверен, что он никогда не попадет в лапы финансовых мошенников, так как он контролирует всю ситуацию. Ему дают такой контроль. То есть эту иллюзию, которая рассыпается после разворота рынка (как ему твердят);</li>
          <li className="post__li">У этого человека есть мечта, как и у многих руководителей или собственников бизнеса. Всю текущую операционную работу делают «специально обученные люди на зарплате»;</li>
          <li className="post__li">Сам занимаешься только ребалансировкой портфеля и основными потоками. Изучает регулярные отчеты, которые ему поставляют, а он уже выбирает из условий : «хорошо» и «плохо». А прибыль достигается заранее придуманному плану. 50% не нужно, достаточно 30% в месяц с меньшим риском.</li>
                        
        </ul>
        <p className="post__body-text">
        И все это ему букетом и предоставляют.<br/><br/>
        Более деятельные и умные со здравым смыслом начинают изучать документы и находить в логике дыры, и отказывают мошенникам, у остальных итог известен.<br/><br/>
        Алгоритм простой:<br/><br/>
        </p>
        <ul>
            <li className="post__li">Позвонят; </li>
            <li className="post__li">Затянут к себе в офис;</li>
            <li className="post__li">Покажут офис, телевизоры, графики. Будет и кофе и вино если нужно;</li>
            <li className="post__li">Заключите договор;</li>
            <li className="post__li">Отправите деньги. </li>                    
        </ul>
        <p  className="post__body-text">И все, больше Вы своих денег не увидите.  </p>       
        <span className="post__body-title title2"><img src={Quote} alt="Quote" className="post__quote"/>«Как определить, что Вам звонит мошенник или реальные профессионалы с финансовой индустрии?»
</span>        
        <p className="post__body-h3">Действуем так:<br/>

Инструмент (заучить наизусть и начинать применять при первом же случае такого звонка).
</p>
    <p  className="post__body-text">Роли<br/><br/></p>
    <ul>
        <li className="post__li">Менеджер;</li>
        <li className="post__li">Вы</li>
    </ul>
    <p  className="post__body-text">Примерный диалог:</p>
        </div>  
        <div className="postItem post__body-img post__body-img_yellow">
        <img src={Dialog} alt="Dialog"/>
        </div>
        <div className="post__body">
            <p className="post__body-text">
                    Все! Этого вполне достаточно для того, что бы собеседник начал думать и сомневаться в своих мероприятиях по захвату Ваших денег. Если это мошенник молодой, неопытный то, скорее всего он закончит разговор, так как на бумаге в скрипте нет такой информации.
                    Лучший исход мошенника по телефонному звонку – это встреча с Вами, а к записям разговора их не готовили.
                    У меня в смартфоне есть такая возможность, как запись телефонных разговоров. Установите себе такое программное обеспечение и тоже пользуйтесь. Ведь это в целях Вашей же безопасности.
                    <br/><br/>
                    Если звонящий продолжает разговор?
                    <br/><br/>
                    В конце статьи я подготовил защитный алгоритм, который сам использую при таких звонках.
                    Отправьте его Вашим друзьям и близким. Распечатайте его и повесьте на стену в офис для Ваших сотрудников. Защищаться нужно уметь всем.
            </p>
            <span className="post__body-h2">КЕЙС 2.<br/>Нам пишет какой – то незнакомый человек в социальных сетях.</span>
            <span className="post__body-h3">Как это происходит?</span>
            <p className="post__body-text">Нам начал писать в социальных сетях неизвестный нам гражданин. Так же обещает сделать нас богатыми и успешными: мол, они уже научились и хотят научить вас.  <br/>
            Можно даже не вступать с ним в переписку, а попросить, чтобы он позвонил вам. Дальше мы уже умеем с ними общаться – возвращаемся в КЕЙС 1.
</p>
            <span className="post__body-h2">КЕЙС 3</span>
        </div>
        <div className="postItem post__body-img post__body-img_black">
            <iframe width="560" height="455" src="https://www.youtube.com/embed/WAg1-0DPD9M?rel=0&amp;controls=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
        </div>
        <div className="post__body">
            <span className="post__body-h2">КЕЙС 4<br/></span>
            <span className="post__body-h2">Подведем итоги</span>
            <p className="post__body-text">Важно запомнить! Никогда не встречайтесь с людьми, которые вам что–то хотят продать на финансовых рынках от неизвестных компаний.<br/>
                Обязательно после звонка изучите вопрос самостоятельно. Потратьте свое время сейчас, чтобы не потерять деньги в последующем. <br/>
                Только после глубокого анализа предложения, имея полную уверенность в том, что предложение поступило от реальной рыночной компании (т. е.компания имеет историю, лицензии и физический офис) можно продолжать общение.<br/><br/>
                
                Алгоритм Вашей защиты:<br/><br/>
            </p>
            <ul>
                <li className="post__li">Применяем инструмент «Ваш звонок записывается»;</li>
                <li className="post__li">Анализируем домены компаний на сервисе типа Who is;</li>
                <li className="post__li">Поиск возможных реальных отзывов в интернете (они отличаются от остальных);</li>
                <li className="post__li">Интересуемся у своих знакомых;</li>
                <li className="post__li">Изучаем компанию;</li>
                <li className="post__li">Принимаем решение о дальнейшем взаимодействии с компанией.</li>
            </ul>  
        
        </div>
        <div className="postItem post__body-img post__body-img_yellow-img"></div>
        <div className="post__body">
            <p className="post__body-text">Если хотите, чтобы проверку предложения провела независимая компания,  обратитесь к нам. Мы профессионально занимаемся […]</p>
            <span className="post__body-h3">Что мы будем делать и как помогать Вам?</span>
            <p className="post__body-text">На главной странице нашего сайта <a href="#!" className="post__link">www.invest–profile.ru</a>  есть кнопка – Нужна помощь. Далее заполняете поля, это совсем не сложно.<br/><br/>

            Мы в свою очередь создадим официальное письмо в эту компанию (может даже и не придётся создавать письмо, а удастся просто опереться на опыт) с определенным блоком вопросов (это классические вопросы, ответы на которые позволяют принимать решения инвестору при выборе компании).<br/><br/>

            Получив ответ на наше письмо, мы проанализируем ответы и сообщим вам наше экспертное мнение: инвестировали бы мы через такого поставщика услуг или нет, и почему. Расскажем, какие последствия может повлечь за собой инвестирование через такую компанию.<br/><br/>

            Делать это мы будем бесплатно. Для нас это не составит труда, а повышение финансовой грамотности наших близких — часть миссии нашей компании.
            </p>
            <div className="post__hashtags">
                <a href="#!" className="post__body-link">#Мир</a> 
                <a href="#!" className="post__body-link">#Труд</a> 
                <a href="#!" className="post__body-link">#Май</a>
                <a href="#!" className="post__body-link">#Ленин</a>
                <a href="#!" className="post__body-link">#СССР</a>
                <a href="#!" className="post__body-link">#Коммунизм</a>
                <a href="#!" className="post__body-link">#Сталин</a>
                <a href="#!" className="post__body-link">#КарлМаркс</a>  
            </div>

        </div>
        <div className="post__body post__best">
            <span className="post__body-h3 post__body-h3_mb">Статьи по теме:<br/></span>
            <div className="sidebar__item">
            <a className="post__body-link">Карта выбора финансовых-инвестиционных продуктов</a>
            <span className="sidebar__post-date post__f21">11 февраля 2009</span>
          </div>
          <div className="sidebar__item">
            <a className="post__body-link">Разбираем Доверительного управляющего (ДУ)</a>
            <span className="sidebar__post-date post__f21">Вчера в 13:15</span>
          </div>
            <div className="sidebar__item">
            <a className="post__body-link">Разбираем Брокера</a>
            <span className="sidebar__post-date post__f21">Сегодня в 02.23</span>
          </div> 
        </div>
